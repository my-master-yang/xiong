...
from openstack_netsec.horizon.utils import settings as utils_settings
...
class PolicyTargetMixin(object):
    ...
    policy_target_attrs = (("project_id", "tenant_id"), ("tenant_id", "tenant_id"), ("user_id", "user_id"),
                           ("domain_id", "domain_id"), ("target.project.domain_id", "domain_id"),
                           ("target.user.domain_id", "domain_id"), ("target.group.domain_id", "domain_id"))
